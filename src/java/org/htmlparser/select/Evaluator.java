package org.htmlparser.select;

import org.htmlparser.helper.Validate;
import org.htmlparser.nodes.Comment;
import org.htmlparser.nodes.Document;
import org.htmlparser.nodes.DocumentType;
import org.htmlparser.nodes.Element;
import org.htmlparser.nodes.Node;
import org.htmlparser.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.htmlparser.nodes.Attribute> values = element.attributes().asList();
            for (org.htmlparser.nodes.Attribute attribute : values) {
